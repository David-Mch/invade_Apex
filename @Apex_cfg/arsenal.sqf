...
_weaponsBasic = [
	...
	'mmg_01_hex_f','mmg_01_tan_f','mmg_02_black_f','mmg_02_camo_f','mmg_02_sand_f','srifle_DMR_02_sniper_F'
];
// marksman rifles
_weaponsMarksman = [
...
_uniformsMedic = [
    "U_B_CombatUniform_mcam",                                       // Combat Fatigues (MTP)
    "U_B_CombatUniform_mcam_tshirt",                                // Combat Fatigues (MTP) (Tee)
	"u_c_paramedic_01_f"                                         // Full Ghillie (Lush) [NATO]
];
...
_headgearPilotCas = [
	'h_PilotHelmetFighter_b','h_PilotHelmetFighter_i'
];
// all vests
_vestsAll = [
...
_vestsBasicPilot = [
"V_TacVest_blk" // Chest Rig (Green)
];

_vestsBasicbuzo_asalto = [
"V_RebreatherB" // Chest Rig (Green)
];
// all backpacks
_backpacksAll = [
...
_backpacksBasic = [
    ...
    "b_carryall_cbr",                                             // Carryall Backpack (MTP)
    "B_Kitbag_mcamo",                                               // Kitbag (MTP)
    "B_Parachute",                                                  // Steerable Parachute
    "",                                             // Bergen Backpack (MTP)

   "B_viperharness_khk_f"                             // Combination Unit Respirator
];
// Large backpacks
_backpacksLarge = [
	'b_bergen_dgtl_f','b_bergen_hex_f','','b_bergen_tna_f',
...
_backpacksbuzo_asalto = [
	"B_viperharness_blk_f","B_AssaultPack_blk"                                            // Assault Pack (Black)
];
// Radio backpacks
_backpacksRadio = [
	'b_radiobag_01_black_f','b_radiobag_01_digi_f','b_radiobag_01_eaf_f','b_radiobag_01_ghex_f','b_radiobag_01_hex_f','b_radiobag_01_mtp_f','b_radiobag_01_tropic_f','b_radiobag_01_oucamo_f','b_radiobag_01_wdl_f'
...
_gogglesAll = [
	...
	'g_sport_blackyellow','g_sport_greenblack','g_sport_checkered','g_sport_red','g_tactical_black','g_aviator','g_lady_mirror','g_lady_dark','g_lady_red','g_lady_blue','g_goggles_vr','g_balaclava_blk','g_balaclava_oli','g_balaclava_combat','g_balaclava_lowprofile','g_bandanna_blk','g_bandanna_oli','g_bandanna_khk',
...
if (_role isEqualTo 'rifleman') exitWith {
	[
		...
		[	// -------------------------------------------------------------- WHITELIST
			...
			(_weaponsBasic + _weaponsMarksmanHeavy + _weaponsHandgun + _weaponsSMG + _weaponsLauncherBasic + _viewersBasic)	// whitelisted WEAPONS
		]
	]
};

if (_role isEqualTo 'Assault_Diver') exitWith {
	[
		[	// -------------------------------------------------------------- BLACKLIST
			[	// ITEMS
				[	// blacklisted uniforms
		...
		[	// -------------------------------------------------------------- WHITELIST
			[	// ITEMS
				_uniformsbuzo_asalto,			// whitelisted UNIFORMS
				_vestsBasicbuzo_asalto,				// whitelisted VESTS
				_inventoryAll,			// whitelisted Inventory
				_assignedItemsBasic,		// whitelisted ASSIGNED ITEMS
				_headgearBasic,			// whitelisted HEADGEAR
				_gogglesbuzo_asalto,			// whitelisted goggles
				_attachmentsAll			// whitelisted Attachments
			],
			_magazinesAll,				// whitelisted MAGAZINES
			_backpacksbuzo_asalto,				// whitelisted BACKPACKS
			(_weaponsbuzo_asalto + _viewersBasic)	// whitelisted WEAPONS
		]
	]
};
// Rifleman role (Grenadier, marksman, engineer, medic, mortar gunner, etc)
if (_role in ['medic','medic_WL']) exitWith {
	[
		...
		[	// -------------------------------------------------------------- WHITELIST
			[	// ITEMS
				_uniformsMedic,			// whitelisted UNIFORMS
				_vestsBasic,				// whitelisted VESTS
				_inventoryAll,			// whitelisted Inventory
				_assignedItemsBasic,		// whitelisted ASSIGNED ITEMS
				_headgearBasic,			// whitelisted HEADGEAR
			...
			_magazinesAll,				// whitelisted MAGAZINES
			_backpacksBasic,				// whitelisted BACKPACKS
			(_weaponsBasic + _weaponsHandgun + _weaponsSMG + _weaponsLauncherBasic + _viewersBasic)	// whitelisted WEAPONS
		]
	]
};
if (_role in ['engineer','mortar_gunner']) exitWith {
	[
		[	// -------------------------------------------------------------- BLACKLIST
			[	// ITEMS
				[	// blacklisted uniforms
...
if (_role isEqualTo 'autorifleman') exitWith {
	[
		...
		[	// -------------------------------------------------------------- WHITELIST
			...
			_magazinesAll,							// whitelisted MAGAZINES
			_backpacksBasic,							// whitelisted BACKPACKS
			(_weaponsSW + _weaponsLMG + _weaponsHandgun + _viewersBasic + _weaponsUW)	// whitelisted WEAPONS
		]
	]
};
...
if (_role isEqualTo 'machine_gunner') exitWith {
	[
		...
		[	// -------------------------------------------------------------- WHITELIST
			...
			_magazinesAll,							// whitelisted MAGAZINES
			_backpacksBasic,							// whitelisted BACKPACKS
			(_weaponsMMG + _weaponsHandgun + _viewersBasic + _weaponsUW)	// whitelisted WEAPONS
		]
	]
};

if (_role isEqualTo 'machine_gunner_WL') exitWith {
	[
		[	// -------------------------------------------------------------- BLACKLIST
			[	// ITEMS
				[	// blacklisted uniforms
...
if (_role isEqualTo 'rifleman_lat') exitWith {
	[
		...
		[	// -------------------------------------------------------------- WHITELIST
			...
			_magazinesAll,								// whitelisted MAGAZINES
			_backpacksBasic,								// whitelisted BACKPACKS
			(_weaponsBasic + _weaponsLauncherRegular + _weaponsHandgun + _weaponsSMG + _viewersBasic)	// whitelisted WEAPONS
		]
	]
};/*/
if (_role isEqualTo 'rifleman_hat') exitWith {
	[
		...
		[	// -------------------------------------------------------------- WHITELIST
			...
			_magazinesAll,								// whitelisted MAGAZINES
			_backpacksBasic,								// whitelisted BACKPACKS
			(_weaponsBasic + _weaponsLauncherHAT + _weaponsHandgun + _weaponsSMG + _viewersBasic)	// whitelisted WEAPONS
		]
	]
};/*/
// Sniper role
if (_role isEqualTo 'sniper') exitWith {
	[
		...
		[	// -------------------------------------------------------------- WHITELIST
			...
			_magazinesAll,							// whitelisted MAGAZINES
			_backpacksBasic,							// whitelisted BACKPACKS
			(_weaponsSniper + _weaponsSMG + _weaponsHandgun + _viewersBasic)	// whitelisted WEAPONS
		]
	]
};
if (_role isEqualTo 'sniper_WL') exitWith {
	[
		[	// -------------------------------------------------------------- BLACKLIST
			[	// ITEMS
				[	// blacklisted uniforms
	...
	[
		...
		[	// -------------------------------------------------------------- WHITELIST
			[	// ITEMS
				...
				_vestsBasicPilot,							// whitelisted VESTS
				_inventoryAll,						// whitelisted Inventory
				_assignedItemsBasic,					// whitelisted ASSIGNED ITEMS
				_headgearPilotCas,						// whitelisted HEADGEAR
				_gogglesAll,						// whitelisted goggles
				_attachmentsAll						// whitelisted Attachments
			],
			_magazinesAll,							// whitelisted MAGAZINES
			_backpacksPilot,							// whitelisted BACKPACKS
			(_weaponsHandgun + _weaponsSMG + _weaponsLauncherBasic + _viewersBasic)	// whitelisted WEAPONS
		]
	]
};

if (_role in ['pilot_heli','pilot_armedheli','pilot_heli_WL']) exitWith {
	[
		[	// -------------------------------------------------------------- BLACKLIST
			[	// ITEMS
				[	// blacklisted uniforms
		...
		[	// -------------------------------------------------------------- WHITELIST
			[	// ITEMS
				_uniformsPilotheli,						// whitelisted UNIFORMS
				_vestsBasicPilot,							// whitelisted VESTS
				_inventoryAll,						// whitelisted Inventory
				_assignedItemsBasic,					// whitelisted ASSIGNED ITEMS
				_headgearPilotheli,						// whitelisted HEADGEAR
				_gogglesAll,						// whitelisted goggles
				_attachmentsAll						// whitelisted Attachments
			],
			_magazinesAll,							// whitelisted MAGAZINES
...
if (_role isEqualTo 'commander') exitWith {
	[
		...
		[	// -------------------------------------------------------------- WHITELIST
			...
			_magazinesAll,							// whitelisted MAGAZINES
			_backpacksAll,							// whitelisted BACKPACKS
			(_weaponsHandgun + _viewersBasic)	// whitelisted WEAPONS
		]
	]
};
...
if (_role isEqualTo 'uav') exitWith {
	[
		...
		[	// -------------------------------------------------------------- WHITELIST
			...
			_magazinesAll,									// whitelisted MAGAZINES
			_backpacksUAV,									// whitelisted BACKPACKS
			(_weaponsBasic + _weaponsHandgun + _weaponsSMG + _viewersBasic)	// whitelisted WEAPONS
		]
	]
};
if (_role isEqualTo 'o_rifleman') exitWith {
	[
		...
		[	// -------------------------------------------------------------- WHITELIST
			...
			((_o_weapons - [_weaponsSW + _weaponsLMG]) + _weaponsHandgun + _weaponsLauncherBasic + _viewersBasic)	// whitelisted WEAPONS
		]
	]
};
if (_role isEqualTo 'o_autorifleman') exitWith {
	[
		...
		[	// -------------------------------------------------------------- WHITELIST
			...
			_magazinesAll,				// whitelisted MAGAZINES
			_o_backpacks,				// whitelisted BACKPACKS
			(_o_weapons + _weaponsHandgun + _weaponsLauncherBasic + _viewersBasic)	// whitelisted WEAPONS
		]
	]
};
// Default
