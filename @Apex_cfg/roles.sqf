...
QS_roles_UI_info = [
	...
	['Assault_Diver','Assault Diver','a3\ui_f\data\map\vehicleicons\iconMan_ca.paa','a3\ui_f\data\map\vehicleicons\iconMan_ca.paa'],
	...
	['pilot_armedheli','pilot Armado','A3\Air_F_Beta\Heli_Transport_01\Data\UI\Map_Heli_Transport_01_base_CA.paa','a3\ui_f\data\map\vehicleicons\iconMan_ca.paa'],
...
QS_roles_UI_info = [
	['rifleman','Rifleman'],
	['Assault_Diver','Assault Diver'],
	['autorifleman','Autorifleman'],
	['machine_gunner','Machine Gunner'],
	['rifleman_lat','Missile specialist'],
	//['rifleman_hat','Rifleman (HAT)'],
	['engineer','Engineer'],
	['medic','Medic'],
	['sniper','Sniper'],
	['crewman','Crewman'],
	...
	['mortar_gunner'],
	['uav','UAV Operator'],
	['pilot_armedheli','Assault pilot'],
	['pilot_heli','Transport Pilot'],
	['pilot_plane','Fighter Pilot'],
	['commander','Commander'],
	['o_rifleman','Rifleman'],
	['o_autorifleman','Autorifleman'],
	['medic_WL','Medic'],
	['machine_gunner_WL','Machine Gunner'],
	['sniper_WL','Sniper'],
	['pilot_heli_WL','Transport Pilot']
];
QS_roles_defaultLoadouts = [
	...
	['Assault_Diver',([[['arifle_sdar_f','','','optic_Hamr',['30Rnd_65x39_caseless_mag_Tracer',30],[],''],[],['hgun_P07_F','','','',['16Rnd_9x21_Mag',16],[],''],['U_B_Wetsuit',[['FirstAidKit',2],['16Rnd_9x21_Mag',3,16]]],['V_RebreatherB',[['30Rnd_65x39_caseless_mag_Tracer',10,30],['SmokeShell',2,1],['HandGrenade',2,1]]],['B_AssaultPack_blk',[]],'H_HelmetB_light','g_diving',['Binocular','','','',[],[],''],['ItemMap','ItemGPS','ItemRadio','ItemCompass','ItemWatch','NVGoggles']],	[['arifle_sdar_f','','','optic_Hamr_khk_F',['30rnd_65x39_caseless_khaki_mag_tracer',30],[],''],[],['hgun_P07_khk_F','','','',['16Rnd_9x21_Mag',16],[],''],['U_B_T_Soldier_F',[['FirstAidKit',2],['16Rnd_9x21_Mag',3,16]]],['V_PlateCarrier1_tna_F',[['SmokeShell',2,1],['HandGrenade',2,1],['30rnd_65x39_caseless_khaki_mag_tracer',10,30]]],['B_AssaultPack_tna_F',[]],'H_HelmetB_Light_tna_F','G_Combat_Goggles_tna_F',['Binocular','','','',[],[],''],['ItemMap','ItemGPS','ItemRadio','ItemCompass','ItemWatch','NVGoggles_tna_F']]] select _tropical)],
...
QS_fnc_roleDescription = compileFinal "
	...
	if (_role in ['Assault_Diver']) then {
		_description = format ['Such personnel are also known by the more formal names of combat diver, combatant diver, or combat swimmer.<br/><br/><img shadow=""0"" align=""center"" size=""18"" image=""media\images\roles\%1\%2.jpg""/>',(['arid','tropic'] select (worldName in ['Tanoa'])),(uiNamespace getVariable ['QS_RSS_currentSelectedRole','rifleman'])];
	};
	...
	if (_role in ['machine_gunner','machine_gunner']) then {
	...
	if (_role in ['machine_gunner_WL','machine_gunner_WL']) then {
		_description = format ['A Machine Gunners job is to provide suppressive fire at long ranges. Unlike their lighter Autorifleman cousins, Machine Gunners may operate as part of a smaller detachment of the squad, and move at a slower pace.<br/><br/><img shadow=""0"" align=""center"" size=""18"" image=""media\images\roles\%1\%2.jpg""/>',(['arid','tropic'] select (worldName in ['Tanoa'])),(uiNamespace getVariable ['QS_RSS_currentSelectedRole','rifleman'])];
	};
	...
	if (_role in ['pilot_armedheli','pilot_heli_WL']) then {
