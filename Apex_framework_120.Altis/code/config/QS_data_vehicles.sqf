...
if (_worldName isEqualTo 'Altis') exitWith {
	[
		...
		/*/[objNull,300,false,{},"B_MBT_01_TUSK_F",[14495.8,16799.5,-0.0748367],316.229,false,0,-1,50,500,-1,4,true,0],/*/
		...
		/*/[objNull,30,false,{},"B_APC_Tracked_01_rcws_F",[14502.9,16823.6,-0.0746937],315.072,false,0,-1,50,500,-1,4,true,0],/*/
		...
		[objNull,30,false,{(_this select 0) allowDamage FALSE;(_this select 0);},"C_Scooter_Transport_01_F",[15399.7,15832.9,0.3],180.183,false,0,-1,50,500,-1,4,true,0],
		[objNull,30,false,{(_this select 0) allowDamage FALSE;(_this select 0);},"C_Scooter_Transport_01_F",[15401.7,15833.2,0.3],180.871,false,0,-1,50,500,-1,4,true,0],
		...
		[objNull,30,false,{},"Box_NATO_Ammo_F",[14518.1,16771.5,1.90735e-006],132.649,false,0,-1,50,500,-1,4,false,0],
		[objNull,30,false,{},"Box_NATO_Ammo_F",[14519.1,16772.5,5.72205e-006],132.651,false,0,-1,50,500,-1,4,false,0],
		[objNull,30,false,{},"Box_NATO_Ammo_F",[14520.1,16773.6,0],132.65,false,0,-1,50,500,-1,4,false,0],
		[objNull,30,false,{},"Box_NATO_Ammo_F",[14521,16774.5,0],132.65,false,0,-1,50,500,-1,4,false,0],
		[objNull,30,false,{},"Box_B_UAV_06_medical_F",[14521.8,16775.2,3.8147e-006],45.7252,false,0,-1,50,500,-1,4,false,0],
		[objNull,30,false,{},"Box_B_UAV_06_medical_F",[14522.4,16775.8,0.000139236],45.7252,false,0,-1,50,500,-1,4,false,0],
...
if (_worldName isEqualTo 'Tanoa') exitWith {
	[
		...
		[objNull,30,TRUE,{},"C_Van_02_medevac_F",[6880.1,7372.95,0.176844],350.992,false,0,-1,50,500,-1,4,TRUE,0],
...
if (_worldName isEqualTo 'Malden') exitWith {
	[
		...
		[objNull,30,false,{},"C_Van_02_medevac_F",[8204.15,10186.5,-0.0730209],180.765,false,0,-1,50,500,-1,4,true,0],
		...
		[objNull,30,false,{(_this select 0) allowDamage FALSE;(_this select 0);},"C_Scooter_Transport_01_F",[8553.51,10106.7,0.3],186.618,false,0,-1,50,500,-1,4,TRUE,0],
