...
Notes 2:
	...
	Hay mucho margen para completar este sistema con tablas de costes y otras cosas para mejorar la capacidad de los vehículos.
...
if (_type isEqualTo 0) exitWith {
	//comentario 'Tipos de objetos cargables';
...
if (_type isEqualTo 2) exitWith {
	//comentar "Tipos de objetos no vehiculares remolcables";
	private _return = FALSE;
...
if (_type isEqualTo 3) exitWith {
	//comentario "Capacidad de retorno";
	private _return = FALSE;
	private _capacity = 0;
	private _count = 0;
	if (_parent isKindOf 'Kart_01_Base_F') then {
...
if (_type isEqualTo 4) exitWith {
	...
	_nonCarryable = [
		...
		'box_eaf_equip_f','box_eaf_uniforms_f','C_IDAP_supplyCrate_F','B_Slingload_01_Medevac_F'
	];
