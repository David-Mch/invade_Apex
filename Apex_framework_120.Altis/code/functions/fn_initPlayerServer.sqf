...
"ColorCorrections" ppEffectCommit 0;
	...
	[
3*60, // segundos para borrar cadáveres (0 significa no borrar)
10, // segundos para borrar vehículos muertos (0 significa no borrar)
1*60, // segundos para borrar vehículos inmóviles (0 significa no borrar)
...
1*60 // segundos para borrar los humos / chemlights (0 significa no borrar)
	] execVM 'code\scripts\repetitive_cleanup.sqf';													// Airbase air defense
	
if (isServer) then { 0 = [] spawn { { _x AllowDamage true; } forEach allUnits; sleep 2; }; };
