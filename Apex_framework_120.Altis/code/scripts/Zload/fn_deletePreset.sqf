...
if!(_loaded isEqualTo false )then
{
	...
	if!(_sel isEqualTo -1)then
	{
		...
		hint parseText format["<br /><img image='code\scripts\ZLoad\img\wr.jpg' /><br />%1 '<t color='#FF0000'>%3</t>' %2<br /> <br /> ",localize "zlo_pres1_text",localize "zlo_pres2_text",(_loaded select _sel)select 0];
