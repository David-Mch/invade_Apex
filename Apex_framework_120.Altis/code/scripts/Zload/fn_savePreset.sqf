...
{
	hint parseText format["<br /><img image='code\scripts\ZLoad\img\wr.jpg' /><br /><t color='#FF0000'>%1</t><br /> <br /> ",localize "zlo_emptyspace_text"];
}else
{ 
	...
	hint parseText format["<br /><img image='code\scripts\ZLoad\img\wr.jpg' /><br />%1 '<t color='#1f8636'>%2</t>' %3<br /> <br />",localize "zlo_pres1_text",_saveName,localize "zlo_saved_text"];
};
