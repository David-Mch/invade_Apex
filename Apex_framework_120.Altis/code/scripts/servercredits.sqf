...
_role1 = "BIENVENIDO";
_role1names = ["SERVER HISPANOAMERICANO"];
_role2 = "REGLAS DEL SERVIDOR:";
_role2names = ["Evita el Fuego amigo o será Expulsado del servidor"];
_role3 = "";
_role3names = ["No haga ping a Zeus con la tecla 'Y' por favor"];
_role4 = "";
_role4names = ["Los comentarios racistas Serán Expulsados. Sin excepciones."];
_role5 = "";
_role5names = ["Los canales Globales y laterales son para discusiones relacionadas con la misión solamente"];
_role6 = "";
_role6names = ["No seleccione un vehiculo aereo si no sabe volar. Práctique en el editor por favor."];
_role7 = "";
_role7names = ["Use los aviones y helis de ataque solo para objetivos designados porfavor no quitar la diversión a la infantería."];
_role8 = "";
_role8names = [""];
 ...
 
{
	...
	_finalText = format ["<t size='0.40' color='#C80000' align='right'>%1<br /></t>", _memberFunction];
