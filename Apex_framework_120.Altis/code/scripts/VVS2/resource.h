#define VVS2_Menu_IDD 38100
#define VVS2_VehicleList 38101
#define VVS2_FilterList 38102
#define VVS2_CargoCheck 38103

class VVS2_RscControlsGroup {
	type = 15;
	idc = -1;
	x = 0;
	y = 0;
...
class VVS2_RscControlsGroupNoScrollbars : VVS2_RscControlsGroup {
...
class VVS2_RscLine : VVS2_RscText {
	idc = -1;
	style = 176;
	x = 0.17;
	y = 0.48;
...
class VVS2_RscTitle : VVS2_RscText {
	style = 0;
	sizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	colorText[] = {0.95, 0.95, 0.95, 1};
};

class VVS2_RscPicture {
	shadow = 0;
	colorText[] = {1, 1, 1, 1};
	x = 0;
	y = 0;
...
class VVS2_RscPictureKeepAspect : VVS2_RscPicture {
	style = 0x30 + 0x800;
};

class VVS2_RscStructuredText {
	type = 13;
	style = 0;
	x = 0;
	y = 0;
...
class VVS2_RscButtonTextOnly : VVS2_RscButton {
	SizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
...
class VVS2_RscButtonMenu : VVS2_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class VVS2_RscShortcutButtonMain : VVS2_RscShortcutButton {
	idc = -1;
	style = 0;
	default = 0;
	w = 0.313726;
...
class VVS2_RscBackground : VVS2_RscText {
	type = 0;
	IDC = -1;
	style = 512;
	shadow = 0;
